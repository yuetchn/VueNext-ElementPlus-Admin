 ...
 * @Author: 乐涛
 * @LastEditTime: 2022-01-25 16:25:04
-->
<template>
  <div>
    <h2>菜单权限测试页</h2>
...
const toggleUser = (type: number) => {
  switch (type) {
    case 1:
      store.dispatch("UserModule/login", { account: "admin", password: "" });
      break;
    case 2:
      store.dispatch("UserModule/login", { account: "test", password: "" });
      break;
    default:
      break;
  }
